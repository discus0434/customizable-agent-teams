...
英語から直訳した漢語や、説明の代わりに置いた比喩は、書き手には内容が詰まって見える。実際には、読み手が指す対象を復元できないぶん情報が減っている。
英語を介して考えた語や言い回しをそのまま日本語へ移すとこの形になりやすいので、書き上げたら語彙と言い回しを通しで点検する。目安は、それを口頭の説明でも使うかどうかである。
