---
name: writing
description: 文章を書く際の規範。文章を作成・推敲・リライトするあらゆる場面（ドキュメントの作成時やユーザーとの会話時、エージェント間の連絡、LLM APIコールを行う際のプロンプト作成時など）において使用する。
---

# 文章規範

ドキュメントの作成時やユーザーとの会話時、エージェント間の連絡、LLM APIコールを行う際のプロンプト作成時などに、文章を書く・推敲するときは、以下の規範に従う。
